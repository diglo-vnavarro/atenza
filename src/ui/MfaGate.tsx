// Pantallas de seguridad para usuarios externos (email/contraseña), MISMA plantilla que el
// acceso (marca a la izquierda, panel traslúcido a la derecha):
//  · VerifyEmailGate — verificar el correo (Firebase lo exige antes de enrolar el 2º factor).
//  · MfaEnrollGate  — enrolar el 2º factor (TOTP) con QR + clave.
// Se muestran a pantalla completa DESPUÉS de autenticar, hasta completar el paso.
...
/** Marco de la pantalla (misma maqueta que el login: marca grande + panel traslúcido a la derecha). */
  ...
  return (
    <div className="login-full">
      ...
      <div className="login-brand-big">
        ...
        <div className="by"><span className="login-aero">by</span><DiglosferaLogo height={34} onDark /></div>
      </div>
...
/** Gate de enrolamiento del 2º factor (TOTP) — QR + clave manual + código. */
