...
interface TenantDoc { name: string; key: string; active: boolean; categories: string[]; categoryTree?: CatNode[]; statuses?: StatusDef[]; picklists?: Picklists; priorityMatrix?: PriorityMatrix; businessHours?: BusinessHours; holidays?: string[]; sites?: string[]; departments?: string[]; userGroups?: string[]; roles?: RoleDef[]; notifRules?: NotifRule[]; closureRules?: ClosureRules; replyTemplates?: ReplyTemplate[]; businessRules?: BusinessRule[]; capacity: Record<string, Capacity>; counter: number }
